...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact River City Arts Foundation. We\'d love to hear from you about our programs, exhibitions, or events.',
  keywords: ['Contact River City Arts Foundation', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our programs, exhibitions, or events? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@rivercityarts.org</p>
                    <p className="text-gray-600">support@rivercityarts.org</p>
                  </div>
                </div>
