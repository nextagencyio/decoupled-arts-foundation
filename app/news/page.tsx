...
export const metadata: Metadata = {
  title: 'News | The Ashwood Arts Foundation',
  description: 'Browse our latest news.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              The latest from The Ashwood Arts Foundation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-serif font-semibold text-gray-600 mb-2">No News Yet</h2>
